module tb;
            ...
            case (inst_reg[31:26])
                6'b000000: begin  // RType
                    case (inst_reg[5:0])
                        ...
                        6'b000000: write2reg(inst_rd, val_rt << inst_reg[10:6]);  // sll (imm) rd=rt<<shamt
                        ...
                        6'b001000: ipc = val_rs;  // jr (Jump Register) pc=rs

                        default $display("NOT IMPLEMENTED : rtype[func: %b]", inst_reg[5:0]);
                    endcase
                end
                6'b000011: begin  // jal (Jump and Link)
                    write2reg(31, ipc);          // Save return address in $ra (register 31)
                    ipc = inst_reg[25:0];        // Jump to target
                end
    ...
    initial begin
        ...
        instructions[0]  = 32'b00100000000111010000100000000000;  // addi (I)
        instructions[1]  = 32'b00001100000100000000000000011101;  // jal  (J)
        instructions[2]  = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[3]  = 32'b00001000000100000000000000110011;  // j    (J)
        instructions[4]  = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[5]  = 32'b00100011101111011111111111110100;  // addi (I)
        instructions[6]  = 32'b10101111101111110000000000001000;  // sw   (I)
        instructions[7]  = 32'b10101111101001000000000000000100;  // sw   (I)
        instructions[8]  = 32'b00101000100000100000000000000010;  // slti (I)
        instructions[9]  = 32'b00010100010000000000000000001101;  // bne  (I)
        instructions[10] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[11] = 32'b00100000100001001111111111111111;  // addi (I)
        instructions[12] = 32'b00001100000100000000000000000101;  // jal  (J)
        instructions[13] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[14] = 32'b10101111101000100000000000000000;  // sw   (I)
        instructions[15] = 32'b10001111101001000000000000000100;  // lw   (I)
        instructions[16] = 32'b00100000100001001111111111111110;  // addi (I)
        instructions[17] = 32'b00001100000100000000000000000101;  // jal  (J)
        instructions[18] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[19] = 32'b10001111101000110000000000000000;  // lw   (I)
        instructions[20] = 32'b00000000011000100001000000100000;  // add  (R)
        instructions[21] = 32'b00001000000100000000000000011000;  // j    (J)
        instructions[22] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[23] = 32'b00000000100000000001000000100000;  // add  (R)
        instructions[24] = 32'b10001111101111110000000000001000;  // lw   (I)
        instructions[25] = 32'b10001111101001000000000000000100;  // lw   (I)
        instructions[26] = 32'b00100011101111010000000000001100;  // addi (I)
        instructions[27] = 32'b00000011111000000000000000001000;  // jr   (R)
        instructions[28] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[29] = 32'b00100011101111011111111111010000;  // addi (I)
        instructions[30] = 32'b10101111101111110000000000101100;  // sw   (I)
        instructions[31] = 32'b10101111101000000000000000101000;  // sw   (I)
        instructions[32] = 32'b00001000000100000000000000101011;  // j    (J)
        instructions[33] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[34] = 32'b10001111101001000000000000101000;  // lw   (I)
        instructions[35] = 32'b00001100000100000000000000000101;  // jal  (J)
        instructions[36] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[37] = 32'b10001111101000110000000000101000;  // lw   (I)
        instructions[38] = 32'b00000000000000110010000010000000;  // sll  (R)
        instructions[39] = 32'b00000011101001000010000000100000;  // add  (R)
        instructions[40] = 32'b10101100100000100000000000000000;  // sw   (I)
        instructions[41] = 32'b00100000011000110000000000000001;  // addi (I)
        instructions[42] = 32'b10101111101000110000000000101000;  // sw   (I)
        instructions[43] = 32'b10001111101000110000000000101000;  // lw   (I)
        instructions[44] = 32'b00101000011000100000000000001010;  // slti (I)
        instructions[45] = 32'b00010100010000001111111111110100;  // bne  (I)
        instructions[46] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[47] = 32'b10001111101111110000000000101100;  // lw   (I)
        instructions[48] = 32'b00100011101111010000000000110000;  // addi (I)
        instructions[49] = 32'b00000011111000000000000000001000;  // jr   (R)
        instructions[50] = 32'b00000000000000000000000000000000;  // nop  (R)
        instructions[51] = 32'b00001000000100000000000000110011;  // j    (J)
        instructions[52] = 32'b00000000000000000000000000000000;  // nop  (R)
        last_instr = 51;
        nsteps = 4358;  
